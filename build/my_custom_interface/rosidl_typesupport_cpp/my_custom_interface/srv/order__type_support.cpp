...
static const _ORDER_Request_type_support_symbol_names_t _ORDER_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_interface, srv, ORDER_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_custom_interface, srv, ORDER_Request)),
  }
};
...
{
  return &::my_custom_interface::srv::rosidl_typesupport_cpp::ORDER_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_custom_interface, srv, ORDER_Request)() {
  return get_message_type_support_handle<my_custom_interface::srv::ORDER_Request>();
}
...
static const _ORDER_Response_type_support_symbol_names_t _ORDER_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_interface, srv, ORDER_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_custom_interface, srv, ORDER_Response)),
  }
};
...
{
  return &::my_custom_interface::srv::rosidl_typesupport_cpp::ORDER_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_custom_interface, srv, ORDER_Response)() {
  return get_message_type_support_handle<my_custom_interface::srv::ORDER_Response>();
}
...
static const _ORDER_type_support_symbol_names_t _ORDER_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_custom_interface, srv, ORDER)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_custom_interface, srv, ORDER)),
  }
};
...
{
  return &::my_custom_interface::srv::rosidl_typesupport_cpp::ORDER_service_type_support_handle;
}
