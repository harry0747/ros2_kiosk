...
#ifndef MY_CUSTOM_INTERFACE__SRV__DETAIL__ROTATEHOME__FUNCTIONS_H_
#define MY_CUSTOM_INTERFACE__SRV__DETAIL__ROTATEHOME__FUNCTIONS_H_
...
/// Initialize srv/ROTATEHOME message.
/**
...
/// Finalize srv/ROTATEHOME message.
/**
...
/// Create srv/ROTATEHOME message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_custom_interface__srv__ROTATEHOME_Request__init().
...
/// Destroy srv/ROTATEHOME message.
/**
 * It calls
 * my_custom_interface__srv__ROTATEHOME_Request__fini()
...
/// Check for srv/ROTATEHOME message equality.
/**
...
/// Initialize array of srv/ROTATEHOME messages.
/**
...
/// Finalize array of srv/ROTATEHOME messages.
/**
 * It calls
 * my_custom_interface__srv__ROTATEHOME_Request__fini()
...
/// Create array of srv/ROTATEHOME messages.
/**
 * It allocates the memory for the array and calls
 * my_custom_interface__srv__ROTATEHOME_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ROTATEHOME messages.
/**
 * It calls
 * my_custom_interface__srv__ROTATEHOME_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ROTATEHOME message array equality.
/**
...
/// Copy an array of srv/ROTATEHOME messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_custom_interface__srv__ROTATEHOME_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_custom_interface
...
/**
 * It calls
 * my_custom_interface__srv__ROTATEHOME_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_custom_interface
...
/**
 * It allocates the memory for the array and calls
 * my_custom_interface__srv__ROTATEHOME_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_custom_interface
...
/**
 * It calls
 * my_custom_interface__srv__ROTATEHOME_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_CUSTOM_INTERFACE__SRV__DETAIL__ROTATEHOME__FUNCTIONS_H_
